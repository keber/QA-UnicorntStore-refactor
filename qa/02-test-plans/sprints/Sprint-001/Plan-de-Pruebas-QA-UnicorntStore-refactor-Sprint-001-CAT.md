...
| 46 | TC-CAT-DETALLE-038 | Agregar al Carrito y Persistencia (Listado + Detalle) | [REGRESION][P1] El toast de confirmación también aparece al agregar desde el detalle | El toast de confirmación también aparece al agregar desde el detalle. | 1) Navegar al detalle de cualquier producto.<br>2) Click en "Agregar al carrito".<br>3) Inspeccionar el DOM del toast. | El toast contiene `"¡Producto agregado al carrito!"`, mismo mensaje que en el listado. | N/A | Automatizado | P1 |
