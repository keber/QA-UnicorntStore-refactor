...
|---|---|---|---|---|---|
| CAT (Catálogo) | LISTADO | ✅ (50 TC) | ⬜ | ⬜ | ✅ Stage 2 completo (POM base ya existe: `page-objects/CatalogPage.ts`) |
| CAT (Catálogo) | DETALLE | ✅ (55 TC) | ⬜ | ⬜ | ✅ Stage 2 completo |
| CARR (Carrito) | CARRITO | ✅ (55 TC) | ⬜ | ⬜ | ✅ Stage 2 completo |
